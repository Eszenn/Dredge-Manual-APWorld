...
def before_create_items_filler(item_pool: list, world: World, multiworld: MultiWorld, player: int) -> list:
    ...
    if not is_option_enabled(multiworld, player, "shuffle_relics"):
        for locationName in locationNames:
            ...
            for i in item_pool:
                if i.name == itemNames[locationNames.index(locationName)]:
                    item_to_place = i
...
def after_create_items(item_pool: list, world: World, multiworld: MultiWorld, player: int) -> list:
    ...
    if is_option_enabled(multiworld, player, "shuffle_relics"):
        relics = ["Ornate Key", "Rusted Music Box", "Jewel Encrusted Band", "Shimmering Necklace",
                  "Antique Pocket Watch"]
        for item in item_pool:
            if item.name in relics:
